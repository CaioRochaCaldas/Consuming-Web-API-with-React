...
//OBS* Para Configuração do Swagger para aceirar o token jwt entre aplicações de autenticação da api devemos por o seguinte codigo

builder.Services.AddSwaggerGen(c => //declaração do swagger ate aqui 
{
